...
public class FileUtils {
    ...
    public Map<String, Object> uploadFiles(MultipartFile file, String filePath) throws Exception {
        ...
        File checkFile = new File(filePath + storedFileName);
        if(checkFile.exists()){
            String randName  = UUID.randomUUID().toString().substring(0, 16);
            storedFileName = nameWithoutExt + "_" + randName + "." + extention;
        }
